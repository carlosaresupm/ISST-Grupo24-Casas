...
public class CerrarCerraduraUITest {
    ...
    public static void setup() {
        ...
        cerradura.put("abierto", true); // Ahora está abierta, queremos cerrarla
    ...
    @Test
    @Order(1)
    public void testCerrarCerraduraDesdeFrontend() {
        ...
        WebElement botonCerrar = new WebDriverWait(driver, Duration.ofSeconds(10))
            .until(ExpectedConditions.elementToBeClickable(By.className("close-button")));
        botonCerrar.click();
        ...
        // Validación de contenido del alert
        assertThat(alertText).contains("✅");

        // Esperar mensaje en pantalla (opcional pero recomendado)
        ...
        assertThat(mensaje.getText().toLowerCase()).contains("puerta");
    }
